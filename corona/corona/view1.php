...
$result = mysqli_query($mysqli, "SELECT * FROM cases WHERE login_id=".$_SESSION['id']." ORDER BY id DESC");
?>
...
<body>
	<a href="index.php">Home</a> | <a href="add1.html">Add New Data</a> | <a href="logout.php">Logout</a>
	<br/><br/>
